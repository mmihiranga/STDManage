...
function Login({navigation}) {
    ...
    const LoginSubmit=() =>{
        ...
        api.post('/authenticate', user).then(async function (response)  {
  ...
  return (
    <View>    
        <View style={styles.centeredView}>
                ...
                <TouchableHighlight underlayColor="transparent" onPress={LoginSubmit} style={styles.AddStudentBtn}>
            <View style={styles.AddStudentBtnContainer}>
                    <Text style={styles.AddStudentBtnText}>Login</Text>
            </View>
     </TouchableHighlight>
     <Text style={styles.signUpText} onPress={() => navigation.navigate('SignUp')} >Create account ? SignUp</Text>
